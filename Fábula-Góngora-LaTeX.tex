...
\author{\fontsize{14}{11.96}\selectfont \textsc{Lvis de Góngora}}
\date{\vspace{60pt}\fontsize{12}{11}\selectfont{\textsc{Texto y variantes de la redacción primitiva}}\\\fontsize{40}{11}\selectfont{\vfill\LaTeX}}
%
...
\emph{Ch} = \emph{\textsc{Obras de D. Lvis de Gongora}} [BNE, RES/45].
%
...
\emph{LVi} = \emph{\textsc{Obras en verso del Homero español}} \emph{que recogio Iuan Lopez de Vicuña}.
%
...
\emph{G1} = \emph{Obras de Luis de Góngora} [BNE, MSS/22217].
%
...
peinar el \edtext{viento}{\Afootnote{monte \emph{corr. G1}}}, fatigar la selva.\par\pend
%
\begin{center}
	[II]
\end{center}
...
\edtext{a Poliphemo, horror de aquella sierra}{\Afootnote{al cabrero mayor de aquella sierra \emph{G1}}},\\
...
\edtext{de un ojo illustra el orbe de su frente}{\Afootnote{el medio orbe illustraba de su frente \emph{G1}}},\\
\edtext{émulo casi del}{\Afootnote{un ojo del \emph{G1}}} mayor lucero)\\
...
que \edtext{redima}{\Afootnote{redimia \emph{G1}}} feroz, salve ligera,\\
su piel manchada de colores ciento:\\
pellico es ya la que en los \edtext{bosques}{\Afootnote{montes \emph{G1}}} era\\
...
del \edtext{mejor}{\Afootnote{primer \emph{G1}}} mundo, del candor primero.\par\pend
\relax
\vfill
\newpage
%
...
\begin{center}
	[XIV]
\end{center}\pstart
Purpureas \edtext{rosas}{\Afootnote{ojas \emph{G1}}} sobre Galathea\\
la Alba entre lilios cándidos deshoja:\\
duda el Amor quál más su color sea,\\
o púrpura nevada, o nieve roja.\\
De su frente la perla es, erithrea,\\
émula vana. El ciego dios se enoja,\\
y, \edtext{condenado}{\Afootnote{condenando \emph{G1}}} su esplendor, la deja\\
...
de quantas \edtext{honra el mar}{\Afootnote{honra el amor \emph{G1}}} deidades era;\\
...
\begin{center}
	[XIX]
\end{center}\pstart
A \edtext{Pales}{\Afootnote{Palas \emph{G1}}}\footnoteE{Pales, divinidad del ganado. \emph{G1} lee «Palas» por Palas Atenea, que pudo ser un error del copista al leer --probablemente-- \emph{a} por \emph{e}, o, quizá, es una lección que perteneció enteramente al texto primitivo.} su viciosa cumbre debe\\
...
\edtext{de sus esquilmos es al ganadero}{\Afootnote{y sus squilmos es de ganadero \emph{G1}}};\\
...
\edtext{el silencio del can siga, y el sueño}{\Afootnote{el silençio del can sigan o el sueño \emph{G1}}}!\par\pend
%
\begin{center}
	[XXIII]
\end{center}\pstart
...
\edtext{segur}{\Afootnote{seguir \emph{Ch}, \emph{G1}}}\footnoteE{La lección \emph{segur} la recoge Pellicer en su \emph{Lecciones solemnes}; \textcite{Alonso1967} la defiende por considerarla \emph{lectio difficilior}. No hay manera de determinar si alguna es un error; ambas lecciones podrían ser correctas.} se hizo de sus azucenas.\\
...
indicio la dexó --aunque \edtext{estatua}{\Afootnote{estaua \emph{G1}}} helada--\\
...
corona immóvil, \edtext{mientras}{\Afootnote{quando no \emph{G1}}} no desciende\\
...
A pesar luego de las \edtext{ramas}{\Afootnote{armas \emph{G1}}}, viendo\\ colorido el bosquexo que ya avía\\
...
\begin{center}
	[XXXVII]
\end{center}\pstart
Acis --aún más de aquello \edtext{que piensa}{\Afootnote{que dispensa \emph{G1}}}\\
...
cíñalo bronce, o \edtext{múrelo}{\Afootnote{muerelo \emph{Ch}}} diamante:\\
que en sus palladïones \edtext{Amor}{\Afootnote{amo \emph{G1}}} ciego,\\
...
el tirio sus matices (si bien \edtext{era}{\Afootnote{ora \emph{Ch}}}\\
de quantas sedas la hiló, gusano,\\
y, artífice, texió la Primavera)\\
reclinados, al mirto mas lozano,\\
una y otra lasciva, si ligera,\\
paloma se \edtext{caló}{\Afootnote{callo \emph{G1}}}, cuyos gemidos\\
...
las columnas \edtext{Ethón}{\Afootnote{Phaeton \emph{G1}}} que erigió el griego,\\
...
\begin{center}
	[XLIV]
\end{center}\pstart
\edtext{Arbitro}{\Afootnote{Arbitrios \emph{G1}}} de montañas y ribera,\\
aliento dio, en la cumbre de la roca,\\
\edtext{a los albogues que agregó la cera}{\Afootnote{aquantas canas agregó la çera \emph{G1}}},\\
...
o \edtext{al disonante}{\Afootnote{altisonante \emph{G1}}} número de almejas\\
...
\edtext{o deribados}{\Afootnote{y despeñados \emph{G1}}} de los ojos míos,\\
...
troncos \edtext{me ofrecen}{\Afootnote{me dan \emph{G1}}} árboles mayores,\\
...
\edtext{a que el monarcha}{\Afootnote{al gran monarcha \emph{G1}}} de esas grutas hondas,\\
en \edtext{trono}{\Afootnote{thono \emph{Ch}; tronco \emph{G1}}} de cristal te abrace nuera,\\
...
¿Qué mucho, si de \edtext{nubes}{\Afootnote{nieues \emph{G1}}} se corona\\
...
\edtext{Corriente}{\Afootnote{luçiente \emph{G1}}} plata al fin sus blancos huesos,\\
