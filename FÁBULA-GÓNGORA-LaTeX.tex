...
%
\setmainfont{TeXGyreTermes}[BoldFont=,Numbers={OldStyle,Proportional}] %Modified TeXGyreTermes with a one.oldstyle more high, because is too small, and a TironianEt adapted from FreeSerif.
