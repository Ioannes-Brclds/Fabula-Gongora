...
%
\setmainfont{TeXGyreThermes}[BoldFont=,Numbers={OldStyle,Proportional}] %Modified TeXGyreTermes [renamed as TeXGyreThermes] with a one.oldstyle more high, because is too small, and a TironianEt sign adapted from GNU FreeSerif.
